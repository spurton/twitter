module Twitter
  module Streaming
    class Event
      LIST_EVENTS = %w[list_created list_destroyed list_updated list_member_added list_member_added list_member_removed list_user_subscribed list_user_subscribed list_user_unsubscribed list_user_unsubscribed]
      TWEET_EVENTS = %w[favorite unfavorite]
